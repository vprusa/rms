...
public class UserServiceImpl implements UserService {
    ...
    /* (non-Javadoc)
     * @see cz.muni.fi.pa165.skupina06.team02.rms.app.service.UserService#registerUser(cz.muni.fi.pa165.skupina06.team02.rms.app.entity.User, java.lang.String)
     */
    @Override
    public void registerUser(User u, String unencryptedPassword) {
        // TODO will we use hash?
        u.setPassword(createHash(unencryptedPassword));
        userDao.create(u);
    }

    /* (non-Javadoc)
     * @see cz.muni.fi.pa165.skupina06.team02.rms.app.service.UserService#getAllUsers()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cz.muni.fi.pa165.skupina06.team02.rms.app.service.UserService#authenticate(cz.muni.fi.pa165.skupina06.team02.rms.app.entity.User, java.lang.String)
     */
    @Override
